...
files = [
    r'c:\xampp\htdocs\bryan\website\resources\views\layouts\student.blade.php',
    r'c:\xampp\htdocs\bryan\website\resources\views\layouts\admin.blade.php',
    r'c:\xampp\htdocs\bryan\website\resources\views\layouts\faculty.blade.php'
]
...
for f in files:
    ...
    content = content.replace("<span>{{ $item['icon'] }}</span>", "<span>{!! $item['icon'] !!}</span>")
    content = content.replace("<span class=\"text-lg\">{{ $item['icon'] }}</span>", "<span class=\"text-lg\">{!! $item['icon'] !!}</span>")
